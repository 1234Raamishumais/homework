...
import { meditationContent } from '../data/mockData';
...
export default function MeditationPage() {
  return (
    <div className="p-6">
      ...
      >
        <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Meditation</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-1">
          Guided meditations to improve your sleep quality
        </p>
      </motion.div>
      ...
      <div className="mt-6">
        <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">Featured</h2>
      ...
      <div className="mt-10">
        <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">Popular Categories</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {['Sleep', 'Stress', 'Anxiety', 'Focus', 'Relaxation', 'Morning', 'Mindfulness', 'Breathing'].map((category, index) => (
            <motion.div 
              key={category}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <div className="mt-10">
        <div className="bg-gradient-to-r from-indigo-500/10 to-purple-600/10 dark:from-indigo-500/20 dark:to-purple-600/20 rounded-xl p-6 border border-indigo-100 dark:border-indigo-800/50">
          <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100">Premium Meditation Library</h3>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Unlock our full library of guided meditations with SleepWell Pro Premium.
          </p>
